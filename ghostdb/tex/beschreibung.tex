...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{img/Post1.jpg}
  \caption{Teilergebnis 1}
  \label{fig: Teilergebnis 1}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{img/Post2.jpg}
  \caption{Teilergebnis 2}
  \label{fig: Teilergebnis 2}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{img/Post3.jpg}
  \caption{Teilergebnis 3}
  \label{fig: Teilergebnis 3}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{img/Post4.jpg}
  \caption{Teilergebnis 4}
  \label{fig: Teilergebnis 4}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{img/Post5.jpg}
  \caption{Teilergebnis 5}
  \label{fig: Teilergebnis 5}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{img/Post-Filtering.jpg}
