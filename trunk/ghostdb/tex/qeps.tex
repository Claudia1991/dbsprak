...
Aus dem Durchschnitt beider Lsiten von \textit{ReisendeIDs} wird ein Bloom-Filter erzeugt. Dieser wird auf das übermittelte Zwischenergebnis des unsicheren Geräts (Reisender.Geschlecht='M') angewendet. Durch Verwendung des MJoin-Operators wird das Ergebnis erzeugt: \{$\langle$R04,Doru,Davidovici,Romänisch$\rangle$\}.
