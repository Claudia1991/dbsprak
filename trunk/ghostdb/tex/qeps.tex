...
\item MJoin(12,11,\begin{math}\langle\end{math}R.ReisenderID,R.Staatsbuergerschaft\begin{math}\rangle\end{math},9) = \{\begin{math}\langle\end{math}R04,Doru,Davidovici,Romänisch\begin{math}\rangle\end{math}\}
\end{enumerate}
